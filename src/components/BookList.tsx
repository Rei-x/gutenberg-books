import { VStack, Spinner, Button, Text, Wrap, WrapItem, ChakraComponent } from '@chakra-ui/react';
...
const BookList = ({ booksQuery }: { booksQuery: UseInfiniteQueryResult<ListBooks, unknown>; }) => {
  ...
  return (
    <Wrap>
      ...
      {booksQuery.isSuccess && <Wrap as={InfiniteScroll as unknown as ChakraComponent<'div'>} spacing="4" style={{ overflow: "hidden" }} hasMore={booksQuery.hasNextPage || false} dataLength={booksLength || 0} next={booksQuery.fetchNextPage} loader={<Loading />}>
